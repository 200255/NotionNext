...
const BLOG = {
  ...
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || false, // 是否显示切换主题按钮 见小组件config
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '做点开心的事，常相遇', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yokiusagi.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '杂物间, 留影簿', // 网站关键词 英文逗号隔开
